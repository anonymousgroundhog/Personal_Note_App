import { E as countColumn, T as combineConfig, b as StateField, c as EditorState, f as Prec, h as RangeSetBuilder, l as Facet, m as RangeSet, v as StateEffect } from "./dist-D0tdy2Vs.js";
import { C as gutter, X as StyleModule, a as Decoration, c as GutterMarker, d as ViewPlugin, o as Direction, p as WidgetType, s as EditorView, z as logException } from "./dist-DupnYy35.js";
...
function clipRTLLines(ranges, doc) {
	...
	for (let { from, to } of ranges) {
		...
		for (;;) {
			...
			if (!cur.lineBreak && buildForLine(cur.value)) if (last && last.to > start - 10) last.to = Math.min(to, end);
...
//#endregion
export { unfoldCode as $, foldState as A, indentService as B, foldCode as C, foldKeymap as D, foldInside as E, getIndentation as F, matchBrackets as G, indentUnit as H, highlightingFor as I, syntaxParserRunning as J, sublanguageProp as K, indentNodeProp as L, foldedRanges as M, forceParsing as N, foldNodeProp as O, getIndentUnit as P, unfoldAll as Q, indentOnInput as R, foldAll as S, foldGutter as T, language as U, indentString as V, languageDataProp as W, syntaxTreeAvailable as X, syntaxTree as Y, toggleFold as Z, defaultHighlightStyle as _, Language as a, IterMode as at, ensureSyntaxTree as b, ParseContext as c, NodeType as ct, TreeIndentContext as d, Tree as dt, unfoldEffect as et, bidiIsolates as f, parseMixed as ft, continuedIndent as g, codeFolding as h, LRLanguage as i, DefaultBufferLength as it, foldable as j, foldService as k, StreamLanguage as l, NodeWeakMap as lt, bracketMatchingHandle as m, HighlightStyle as n, styleTags as nt, LanguageDescription as o, NodeProp as ot, bracketMatching as p, syntaxHighlighting as q, IndentContext as r, tags as rt, LanguageSupport as s, NodeSet as st, DocInput as t, Tag as tt, StringStream as u, Parser as ut, defineLanguageFacet as v, foldEffect as w, flatIndent as x, delimitedIndent as y, indentRange as z };

//# sourceMappingURL=dist-BwbBXsuw.js.map