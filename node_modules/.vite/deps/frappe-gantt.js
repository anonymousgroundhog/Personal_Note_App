...
var F = class {
	...
	draw_progress_bar() {
		...
		this.$date_highlight = this.gantt.create_el({
			...
			width: this.width,
			left: e
		}), this.gantt.$lower_header.prepend(this.$date_highlight), Y(this.$bar_progress, "width", 0, this.progress_width);
	}
	...
	compute_x() {
		...
		this.x = d.diff(e, i, this.gantt.config.unit) / this.gantt.config.step * t;
	}
	compute_y() {
