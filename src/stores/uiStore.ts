...
export type AppView = 'notes' | 'tags' | 'sync' | 'diagram' | 'ai' | 'gsd' | 'code' | 'web' | 'finance' | 'security' | 'communications' | 'help' | 'accessibility' | 'audio-to-text' | 'minecraft' | 'academia' | 'research' | 'vault-snapshot'
